...
public class SQLCommands
{
    ...
    public static readonly string CREATE_MEEPL_ENDUSER_SERVERS = "CREATE TABLE IF NOT EXISTS MEEPL_ENDUSER_SERVERS (MEEPL_SERVER_ID BIGINT, METADATA BYTEA);";
    ...
    public static readonly string CREATE_PROFILE_SERVERLIST_TABLE = "CREATE TABLE IF NOT EXISTS PROFILE_SERVERLIST (TABLEBOUND_ID BIGINT UNIQUE PRIMARY KEY, SERVERLIST_CONTAINER_BLOB BYTEA, BLOBHASH VARCHAR(128), CONSTRAINT FK_TID FOREIGN KEY (TABLEBOUND_ID) REFERENCES TABLEBOUND_PROFILE(TABLEBOUND_ID));";
