...
public class SQLCommands
{
    ...
    public static readonly string CREATE_CLUBS_TABLE = "CREATE TABLE IF NOT EXISTS CLUBS (CLUB_ID BIGINT PRIMARY KEY, NAME VARCHAR(255), DESCRIPTION VARCHAR(255), SECRET VARCHAR(255), OWNER BIGINT);";
