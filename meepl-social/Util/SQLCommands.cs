...
public class SQLCommands
{
    ...
    public static readonly string CREATE_PROFILE_SERVERLIST_TABLE = "CREATE TABLE IF NOT EXISTS PROFILE_SERVERLIST (TABLEBOUND_ID BIGINT UNIQUE PRIMARY KEY, SERVERLIST_CONTAINER_BLOB BYTEA, CONSTRAINT FK_TID FOREIGN KEY (TABLEBOUND_ID) REFERENCES TABLEBOUND_PROFILE(TABLEBOUND_ID));";
