...
public class SQLCommands
{
    ...
    public static readonly string CREATE_PROFILE_BADGES_TABLE = "CREATE TABLE IF NOT EXISTS PROFILE_BADGES (TABLEBOUND_ID BIGINT, BADGE_CONTAINER_BLOB BYTEA, BLOBHASH VARCHAR(128), CONSTRAINT FK_TID FOREIGN KEY (TABLEBOUND_ID) REFERENCES TABLEBOUND_PROFILE(TABLEBOUND_ID));";
    public static readonly string CREATE_PROFILE_EVENTS_TABLE = "CREATE TABLE IF NOT EXISTS PROFILE_EVENTS (TABLEBOUND_ID BIGINT, EVENT_CONTAINER_BLOB BYTEA, BLOBHASH VARCHAR(128), CONSTRAINT FK_TID FOREIGN KEY (TABLEBOUND_ID) REFERENCES TABLEBOUND_PROFILE(TABLEBOUND_ID));";
